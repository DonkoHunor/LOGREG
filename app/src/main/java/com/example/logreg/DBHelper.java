...
public class DBHelper extends SQLiteOpenHelper {
    ...
    private static final String DB_NAME = "adatbazis.db";
    ...
    public boolean rogzites(String email, String felhnev, String jelszo, String teljesnev){
        ...
        System.out.println(values + "Hiba");
        return result != -1;
    }

    public Cursor adatLekerdezes() {
        SQLiteDatabase db = this.getReadableDatabase();
        return db.query(TABLE_NAME, new String[] {COL_EMAIL, COL_FELHNEV,COL_JELSZO,COL_TELJESNEV},
